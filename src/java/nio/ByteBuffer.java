...
public abstract class ByteBuffer
    ...
    // todo : ByteBuffer 我们发现这里的构造方法是包访问权限，外部是没法写一个子类去继承该类的，不利于扩展
     ...
     * 根据 position 读取 当前位置的 byte 数据，读取完之后 position 会自增
     *
     ...
     * 在当前 position 位置添加一个 byte 字节数据，添加完 position 会自增
     *
